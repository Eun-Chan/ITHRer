...
<div class="contentwrap">
	<article class="container">
		...
		<form action="${pageContext.request.contextPath }/user/companyPasswordUpdate.ithrer" method="POST" class="form-horizontal" onsubmit="return passwordUpdateSubmit();">
			<div class="form-group">
				<label for="userId" class="col-sm-2 control-label">아이디</label>
				<div class="col-sm-4">
					<input type="text" class="form-control" id="compId" name="compId" value="${company.compId }"readonly>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="password" class="form-control" id="companyPasswordOk" placeholder="비밀번호를 한번 더 입력하세요."/>
...
<script>
	...
	$("#companyPasswordOk").keyup(function(e){
		var pwd = $("#password").val().trim();
		var pwd_ok = $("#companyPasswordOk").val().trim();
	...
	function passwordUpdateSubmit(){
		if(companyPassword_OK == 1 && pwd_Same == 1){
			return true;
		}
		console.log(companyPassword_OK);
