package com.spring.ithrer.listener;
...
public class SessionBindingListener implements HttpSessionBindingListener{
		...
		// (기업회원용)
		private static SessionBindingListener SessionBindingListener2 = null;
		...
		public static synchronized SessionBindingListener getInstance2() {
			if(SessionBindingListener2 == null) {
				SessionBindingListener2 = new SessionBindingListener();
			}
